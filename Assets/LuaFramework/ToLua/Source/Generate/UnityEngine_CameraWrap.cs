...
public class UnityEngine_CameraWrap
{
	...
	static int SubmitRenderRequests(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.CheckObject(L, 1, typeof(UnityEngine.Camera));
			System.Collections.Generic.List<RenderPipeline.StandardRequest> arg0 = (System.Collections.Generic.List<RenderPipeline.StandardRequest>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<RenderPipeline.StandardRequest>));
			obj.SubmitRenderRequest(arg0);
			return 0;
		}
		catch(Exception e)
		{
